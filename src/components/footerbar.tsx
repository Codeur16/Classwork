  ...
  return (
    ...
    <footer className="footer">
      ...
      <div className="footer-content">
        <div className="footer-content-column">
          <div className="footer-logo">
            <a className="footer-logo-link" href="./">
              ...
              <span className="hidden-link-text">ClassWork</span>
              <h1><span style={{color:"#22a2e3"}}>Class</span>work</h1>
            </a>
          </div>
        ...
        <div className="footer-content-column">
          <div className="footer-menu">
            <h2 className="footer-menu-name"> Organosation</h2>
        ...
        <div className="footer-content-column">
          <div className="footer-menu">
            ...
            <ul id="menu-quick-links" className="footer-menu-list">
              <li className="updat menu-item menu-item-type-custom menu-item-object-custom">
                <a target="_blank" rel="noopener noreferrer" href="./">Accueuil</a>
              </li>
              <li className="menu-item menu-item-type-custom menu-item-object-custom">
                <a target="_blank" rel="noopener noreferrer" href="./">Tableau de bord</a>
              </li>
              <li className="menu-item menu-item-type-post_type menu-item-object-page">
                <a href="./">Rejoindre un cours</a>
              </li>
              <li className="menu-item menu-item-type-post_type menu-item-object-page">
                <a href="./">Evaluation</a>
              </li>
        ...
        <div className="footer-content-column">
          <div className="footer-call-to-action">
            <h2 className="footer-call-to-action-title"> Discussion</h2>
            <p className="footer-call-to-action-description"> Vous avez une question d'assistance?</p>
            <a className="footer-call-to-action-button button" href="./" target="_self"> Prenez contact</a>
          </div>
          <div className="footer-call-to-action">
            <h2 className="footer-call-to-action-title"> Contactez nous</h2>
            <p className="footer-call-to-action-link-wrapper"> <a className="footer-call-to-action-link" href="tel:0124-64XXXX" target="_self"> (+237)220254879 <br/> classwork@gmail.com </a></p>
          </div>
        </div>
      ...
      <div className="footer-copyright">
        <div className="footer-copyright-wrapper">
          <p className="footer-copyright-text">
            <a className="footer-copyright-link" href="./" target="_self"> ©2023. | Designed By: Loico. | All rights reserved. </a>
          </p>
        </div>
      </div>
    </footer>
